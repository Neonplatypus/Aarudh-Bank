	...
	<div class="row">
		<div class="col-md-3 d-flex justify-content-center">
			<h1 class="text-success">
				<i class="fas fa-university"></i> Aarudh Bank
			</h1>
		</div>
		...
		<div class="col-md-6 text-center font-weight-bold">
			<div class="row mt-3">
				<div class="col-md-4">
					<i class="fas fa-phone-square-alt text-success"></i> +9165952132656
				</div>
				<div class="col-md-4 ">
					<i class="fas fa-envelope-square text-success"></i> help@aarudhbank.com
				</div>
				<div class="col-md-4 ">
